...
public class CompletelyUseless {
    ...
    public CompletelyUseless(String mime, Charset charset, byte[] data) {
        this(mime, charset, null, null, data);
    }

    public CompletelyUseless(String mime, Charset charset, String filename, String contentDisposition, byte[] data) {
        this.mime = mime;
    ...
    public boolean equals(Object obj) {
        ...
        final CompletelyUseless other = (CompletelyUseless) obj;
     ...
     */
    @SuppressLint("NewApi")
    public static CompletelyUseless parse(String uri, Charset charset) {
        ...
        CompletelyUseless dataURIObject = new CompletelyUseless(
                finalMimeType,
                finalCharset,
                finalFilename,
